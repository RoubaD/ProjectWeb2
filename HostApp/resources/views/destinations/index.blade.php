...
.search-container {
    ...
    margin: 0 auto;
    position: relative;
    margin-top: 20vh; /* Centers the search bar vertically */
    gap: 15px; /* Space between icons and the search bar */
}

.search-bar-container {
    flex-grow: 1; /* Search bar adapts to available space */
    max-width: 600px; /* Restricts the maximum width for the search bar */
}

.search-bar {
    width: 100%; /* Full width within its container */
    padding: 12px; /* Smaller padding for a more compact design */
    border: none;
    border-radius: 50px;
...
.search-bar::placeholder {
    ...
    font-size: 1rem; /* Slightly smaller placeholder text */
    text-align: center;
}
...
.filter-button, .map-search-button {
...
.filter-button:hover, .map-search-button:hover {
    background-color: #b7a7a9;
    box-shadow: 0px 8px 20px rgba(0, 0, 0, 0.15);
}

.filter-button {
    background: url('images/filter.png') no-repeat center center; /* Replace with your filter icon */
    background-size: cover;
}

.map-search-button {
    background: url('images/location.png') no-repeat center center; /* Replace with your map icon */
    background-size: cover;
}
